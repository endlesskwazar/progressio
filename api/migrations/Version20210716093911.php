 ...
 */
final class Version20210716093911 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE todos (id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', title VARCHAR(200) NOT NULL, description VARCHAR(1600) DEFAULT NULL, due DATE DEFAULT NULL COMMENT \'(DC2Type:date_immutable)\', type VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
